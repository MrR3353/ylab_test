...
def cached(key: CacheEntity, menu_id: int = 0, submenu_id: int = 0, dish_id: int = 0):  # caching get responses, getting or setting key
    def inner(func):
...
class CacheRepository:
    ...
    @switch
    async def get(self, key: CacheEntity, menu_id: int = 0, submenu_id: int = 0, dish_id: int = 0):
    ...
    @switch
    async def set(self, key: CacheEntity, value, menu_id: int = 0, submenu_id: int = 0, dish_id: int = 0):
        if key == CacheEntity.menu_list:
    ...
    @switch
    async def delete(self, *args: CacheEntity, menu_id: int = 0, submenu_id: int = 0, dish_id: int = 0):
        for arg in args:
